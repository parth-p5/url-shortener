// create .env in root of the project and declare connection string there.
// connectionString=connectionString=mongodb://user:password@devservers
...
promise.then(function() {
    ...
    Counter.remove({}, function() {
        ...
        var counter = new Counter({_id: 'url_count', count: 0});
